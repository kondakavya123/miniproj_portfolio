...
import { buttonItemLayout,FACULTY } from '../../constants/constants';
import { getAllProgrammes } from '../../redux/actions/initeval1';
import { SEMESTER_OPTIONS } from '../../Constants';
import { getScheduledExam, getStudentAnsScriptByProgSemCourse } from '../../redux/actions/coordinatorActions';
...
const FacultyDashboard = () => {
  ...
  const studentAnsScriptColumn = [
    ...
    
    {
      ...
      width: "10%",
      render: (_, record) => (
        <Link to="/student-ans-marks" state={{ record: record }}>
